...
<h2 class="main_title">
    ...
    <span  id="MList" runat="server">ﬁ«∆„… «·—ƒ”«¡  </span></h2>
<asp:MultiView ID="MultiView1" runat="server">
        ...
        <asp:GridView SkinID="mangers_grid"  ID="mangers_grid" runat="server" AutoGenerateColumns="False" ShowHeader="false">
                    ...
                    <ItemTemplate>
                        <%--<ul class="mangerList"> <li>--%> 
                          <%--<a runat="server" href='<%# string.Concat(CVPath(),Eval("Man_CV_Path")) %>'>
                               ...
                               <asp:LinkButton CssClass="mangerList_link" ID="Link_Manger_Name" runat="server" Text='<%# Bind("Man_Arabic_Name") %>'
            ...
            <ItemTemplate >
                <%--<a id="A1" runat="server" href='<%# string.Concat(CVPath(Eval("Man_ID").ToString()),Eval("Man_CV_Path")) %>'
                  visible='<%#System.IO.File.Exists(Server.MapPath (string.Concat(CVPath(Eval("Man_ID").ToString()),Eval("Man_CV_Path")))) %>'>
                  --%>
                  
                 <%--<a id="A1" runat="server" href='<%# string.Concat(CVPath(Eval("Man_ID").ToString()),Eval("Man_CV_Path")) %>'>--%>
                
                    <asp:Image ID="Manger_Image" runat="server" ImageUrl='<%#string.Concat(ImagePath(Eval("Man_ID").ToString()), Eval("Man_Photo_Path"))  %>'
                     Visible='<%#System.IO.File.Exists(Server.MapPath (string.Concat(ImagePath(Eval("Man_ID").ToString()), Eval("Man_Photo_Path")))) %>'  Width="111px" Height="144px" />
               <%-- </a>--%>
              <%--<asp:LinkButton CssClass="mangerList_link" ID="Link_Manger_Name" runat="server" Text='<%# Bind("Man_Arabic_Name") %>'
                            OnClick="LinkButton1_Click" />--%>
            </ItemTemplate>
    ...
    <asp:View ID="View2" runat="server">
        <table class="front">
            <tr>
                <td class="bg">
                    <asp:Label ID="Label1" CssClass="Label_form" runat="server" Text="«”„ «·—∆Ì”"></asp:Label></td>
                <td class="bg2">
            ...
            <tr>
                <td class="bg">
                    <asp:Label ID="Label2" CssClass="Label_form" runat="server" Text=" «—ÌŒ  Ê·Ì «·„‰’»"
            ...
            <tr>
                <td class="bg">
                    <asp:Label ID="Label3" CssClass="Label_form" runat="server" Text=" «—ÌŒ  —ﬂ «·„‰’»"
            ...
            <tr>
                <td class="bg">
                    <asp:Label ID="Label4" CssClass="Label_form" runat="server" Text="—ﬁ„ «· ·Ì›Ê‰" Width="128px"></asp:Label></td>
                <td class="bg2">
                    <asp:Label ID="Label_Manger_Phone" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td class="bg" ><%--style="height: 30px"--%>
                    <asp:Label ID="Label6" CssClass="Label_form" runat="server" Text="«·»—Ìœ «·«·ﬂ —Ê‰Ì "
                        Width="128px"></asp:Label></td>
            ...
            <tr>
                <td class="bg">
                    <asp:Label ID="Label5" runat="server" CssClass="Label_form" Text="«·”Ì—… «·–« Ì…"
                        Width="128px"></asp:Label></td>
                <td class="bg2">
                    <asp:HyperLink ID="CV_Link" Target="_blank"  runat="server"> Õ„Ì· «·”Ì—… «·–« Ì…</asp:HyperLink></td>
            </tr>
        </table>
    </asp:View>
</asp:MultiView>
