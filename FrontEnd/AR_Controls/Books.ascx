...
<asp:Label id="Label1" runat="server" Text="ÇáÊÕäíÝÇÊ" Width="70px"></asp:Label>
<asp:DropDownList id="DDLCategory" runat="server" AutoPostBack="True"></asp:DropDownList>
<asp:Label id="Label2" runat="server" Text="ãßÇä ÇáÊæÇÌÏ" Width="75px"></asp:Label>
