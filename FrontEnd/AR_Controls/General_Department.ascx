...
<asp:GridView ID="governorate_grid" runat="server"  AutoGenerateColumns="False" ShowHeader="False">
    <Columns>
        <asp:TemplateField HeaderText="ÇáãÏíÑíÇÊ">
            <ItemTemplate>
        ...
        <table class="front">
            <tr>
                <td class="bg" style="height: 21px">
                    <asp:Label ID="Label6" runat="server" CssClass="Label_form" Text="ÇÓã ÇáÇÏÇÑÉ"></asp:Label></td>
                <td class="bg2" style="height: 21px">
                    <asp:Label ID="lit_name" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td class="bg" style="height: 21px">
                    <asp:Label ID="Label4" runat="server" CssClass="Label_form" Text="ãÏíÑ ÚÇã ÇáÇÏÇÑÉ"></asp:Label></td>
                <td class="bg2" style="height: 21px">
           ...
           <tr>
                <td class="bg" style="height: 21px">
                    <asp:Label ID="Label8" runat="server" CssClass="Label_form" Text="ÚäæÇä ÇáÅÏÇÑÉ"></asp:Label></td>
                <td class="bg2" style="height: 21px">
            ...
            <tr>
                <td class="bg" style="height: 21px">
                    <asp:Label ID="Label3" runat="server" CssClass="Label_form" Text="ÇÑÞÇã ÇáÊáíÝæäÇÊ"></asp:Label></td>
                <td class="bg2" style="height: 21px">
                    <asp:Label ID="Lit_Telephone" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td class="bg" style="height: 21px">
                    <asp:Label ID="Label5" runat="server" CssClass="Label_form" Text="ÇáÝÇßÓ"></asp:Label></td>
                <td class="bg2" style="height: 21px">
                    <asp:Label ID="Lit_Fax" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td class="bg" style="height: 21px">
                    <asp:Label ID="Label7" runat="server" CssClass="Label_form" Text="ÇáÈÑíÏ ÇáÇáßÊÑæäí "
            ...
            <tr>
                <td class="bg" style="height: 21px">
                    <asp:Label CssClass="Label_form" ID="Literal1" runat="server" Text="ÇáÇäÌÇÒÇÊ"></asp:Label></td>    
                <td class="bg2" style="height: 21px">
                    <asp:Label ID="Lit_Achivments" runat="server"></asp:Label></td>
            </tr>
            <tr>
                    <td class="bg">
                    <asp:Label CssClass="Label_form" ID="Literal2" runat="server" Text="ÇáÇäÔØÉ"></asp:Label></td>
                <td class="bg2">
                    <asp:Label ID="Lit_Activity" runat="server"></asp:Label></td>
            </tr>
            <tr>
                    <td class="bg">
                    <asp:Label CssClass="Label_form" ID="Literal3" runat="server" Text="ÊÇÑíÎ "></asp:Label></td>
                    <td class="bg2">
                    <asp:Label ID="Lit_Histoty" runat="server"></asp:Label></td>
            </tr>
            <tr>
                    <td class="bg" style="height: 21px">
                    <asp:Label CssClass="Label_form" ID="Literal5" runat="server" Text="ÇáÇåÏÇÝ"></asp:Label></td>
                <td class="bg2" style="height: 21px">
                    <asp:Label ID="Lit_Goals" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td class="bg">
                    <asp:Label ID="Label1" runat="server" CssClass="Label_form" Text="ÇáÎÏãÇÊ ÇáÊí ÊÞÏãåÇ "></asp:Label></td>
            ...
            <tr>
                <td class="bg">
                    <asp:Label ID="Label2" runat="server" CssClass="Label_form" Text="ÇáÇÏÇÑÇÊ ÇáÊÇÈÚÉ "></asp:Label></td>
               <%-- <td class="bg2" dir="ltr">--%>
                 <td class="bg2" >
                    <asp:GridView ID="gov_dep_grid" runat="server" AutoGenerateColumns="False" ShowHeader="False" Width="605px">
                        <Columns>
                            <asp:TemplateField HeaderText="ÇáÇÏÇÑÇÊ">
                                <ItemTemplate>
