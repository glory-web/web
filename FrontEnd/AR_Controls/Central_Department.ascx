...
<asp:GridView ID="governorate_grid" runat="server"  AutoGenerateColumns="False" ShowHeader="False">
        ...
        <table class="front">
            <tr>
                <td class="bg" style="width: 177px">
                    <asp:Label ID="Label3" runat="server" CssClass="Label_form" Text="ÇÓã ÇáÇÏÇÑÉ"></asp:Label></td>
                <td class="bg2">
                    <asp:Label ID="Lit_name" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td class="bg" style="width: 177px">
                    <asp:Label ID="Label1" runat="server" CssClass="Label_form" Text="ÑÆíÓ ÇáÇÏÇÑÉ"></asp:Label></td>
                <td class="bg2">
   ...
   <tr>
                <td class="bg" style="width: 177px">
                    <asp:Label CssClass="Label_form" ID="Label4" runat="server" Text="ÇáÚäæÇä"></asp:Label></td>    
                <td class="bg2">
                    <asp:Label ID="Lit_Address" runat="server"></asp:Label></td>
            </tr>
                        <tr>
                <td class="bg" style="width: 177px">
                    <asp:Label CssClass="Label_form" ID="Literal1" runat="server" Text="ÑÞã ÇáÊáíÝæä"></asp:Label></td>    
                <td class="bg2">
                    <asp:Label ID="Lit_Telephone" runat="server"></asp:Label></td>
            </tr>
            <tr>
                    <td class="bg" style="width: 177px; height: 21px;">
                    <asp:Label CssClass="Label_form" ID="Literal2" runat="server" Text="ÑÞã ÇáÝÇßÓ"></asp:Label></td>
                <td class="bg2" style="height: 21px">
                    <asp:Label ID="Lit_Fax" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td class="bg" style="width: 177px; height: 21px">
                    <asp:Label ID="Label6" runat="server" CssClass="Label_form" Text="ÇáÈÑíÏ ÇáÇáßÊÑæäí "
                            ...
                            <asp:TemplateField HeaderText="ÇáÎÏãÇÊ">
                                <ItemTemplate>
                                    <asp:Label  ID="LinkButton1" runat="server" 
                                        Text='<%# Bind("ORG_Arabic_Name") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
