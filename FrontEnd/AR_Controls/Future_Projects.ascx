...
<asp:MultiView ID="MultiView1" runat="server">
    <asp:View ID="View1" runat="server">
        <asp:GridView ID="projects_grid" runat="server" AutoGenerateColumns="False" ShowHeader="true">
            <Columns>
                <asp:TemplateField HeaderText="„‘«—Ì⁄ ÃœÌœ…" HeaderStyle-CssClass="HighLightsHead">
                    <ItemTemplate>
    ...
    <asp:View ID="View2" runat="server">
       <table class="front">
           ...
           <%-- <tr>
                <td class="bg">
                    <asp:Label CssClass="Label_form" ID="Label6" runat="server" Text="„·›«  «·„‘—Ê⁄" Width="108px"></asp:Label></td>
                <td class="bg2">
        ...
        <asp:Label ID="NoProject" runat="server" Text="·« ÌÊÃœ „‘«—Ì⁄ „” ﬁ»·Ì…" Visible="False"
