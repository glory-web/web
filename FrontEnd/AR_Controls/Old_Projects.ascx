...
<asp:MultiView ID="MultiView1" runat="server">
    <asp:View ID="View1" runat="server">
        <asp:GridView ID="projects_grid" runat="server" AutoGenerateColumns="False" ShowHeader="true">
            <Columns>
                <asp:TemplateField HeaderText="„‘«—Ì⁄  „ «·«‰ Â«¡ „‰Â«" HeaderStyle-CssClass="HighLightsHead">
                    <ItemTemplate>
    ...
    <asp:View ID="View2" runat="server">
      <table class="front">
           ...
           <tr>
                <td class="bg">
                    <asp:Label CssClass="Label_form" ID="Label2" runat="server" Text="Ê’› «·„‘—Ê⁄"></asp:Label>
               </td><td class="bg2">
                    <span class="testasd"><asp:Label  ID="Label_Proj_Discreption" runat="server"></asp:Label></span>
            </td></tr>
            <tr>
                <td class="bg">
                    <asp:Label CssClass="Label_form" ID="Label3" runat="server" Text=" «—ÌŒ »œ«Ì… «·„‘—Ê⁄"></asp:Label>
                </td><td class="bg2">
                    <asp:Label ID="Label_Project_StartDate" CssClass="Label_details" runat="server"></asp:Label>
            </td></tr>
            <tr>
                <td class="bg">
                    <asp:Label CssClass="Label_form" ID="Label4" runat="server" Text=" «—ÌŒ ‰Â«Ì… «·„‘—Ê⁄"></asp:Label>
               </td><td class="bg2">
                    <asp:Label CssClass="Label_details" ID="Label_Project_EndDate" runat="server"></asp:Label>
            </td></tr>
           <tr>
                <td class="bg" style="height: 21px">
                    <asp:Label CssClass="Label_form" ID="Label5" runat="server" Text="—«»ÿ «·„‘—Ê⁄"></asp:Label>
                </td><td class="bg2" style="height: 21px">                    
                    <asp:HyperLink CssClass="Label_details" ID="Project_Link" runat="server" Target="_blank">«÷€ÿ Â‰«</asp:HyperLink>
          ...
          <tr>
            ...
            <%--<tr>
                <td class="bg">
                    <asp:Label CssClass="Label_form" ID="Label6" runat="server" Text="„·›«  «·„‘—Ê⁄"></asp:Label>
               </td><td class="bg2">
        ...
        <asp:Label ID="NoProject" runat="server" Text="·« ÌÊÃœ „‘«—Ì⁄ " Visible="False"
