    ...
    <tr>
        <td colspan="2">
            <asp:GridView ID="links_grid" CssClass="Links_style" runat="server" AutoGenerateColumns="False" ShowHeader="true" ShowFooter="true"
                Width="100%">
                <Columns>
                    <asp:TemplateField HeaderText="«·‰Ÿ„ «·Œ»Ì—… ··’Õ… «·ÕÌÊ«‰Ì…" HeaderStyle-CssClass="HighLightsHead">
                        <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" CssClass="HighLightsItems" runat="server" Text='<%# Bind("ESArabicTitle") %>'
