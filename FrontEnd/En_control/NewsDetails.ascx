...
<asp:MultiView ID="MultiView1" runat="server" >
    <asp:View ID="View1" runat="server" >
        <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
            <ItemTemplate>
                <asp:Label ID="Label1" CssClass="GridViewH HighLightsHead" Width="100%" runat="server" Text='<%# Bind("Cat_English_Name") %>' Visible='<%# TextVisible(Eval("Cat_ID").ToString()) %>'></asp:Label>
                <asp:GridView ID="news_grid" runat="server" AutoGenerateColumns="False" ShowHeader="false"   Width="650px">
                    <Columns>
                        <asp:TemplateField HeaderText="">
                            <ItemTemplate>
                                <asp:LinkButton CssClass="HighLightsItems" ID="LinkButton1" runat="server" Text='<%# Bind("News_English_Title") %>'
                                    OnClick="LinkButton1_Click">LinkButton</asp:LinkButton>
                                    
                                  <p class="NewsContent"><asp:Label ID="Label2" runat="server" Text='<%# NewsContent(Eval("News_English_Content").ToString()) %>'></asp:Label></p>
    ...
    <asp:View ID="View2" runat="server">
        ...
        <asp:Image ID="News_Image" runat="server"></asp:Image>
