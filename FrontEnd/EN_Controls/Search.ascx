...
<table dir="rtl" style="width:180px">
    <tr>
    ...
    <tr >
        ...
        <td valign="middle" style="padding-bottom:13px">
         <asp:Button CssClass="search_btn" ID="Button1" runat="server" OnClick="Button1_Click" Text="Search" />
        </td>
    </tr>
    <tr>
        <td>
            <asp:RegularExpressionValidator ID="regexpSSN" runat="server"         
                                    ...
                                    ValidationExpression="^[a-zA-Z0-9.\s¡-Ì]{1,100}$" />
        </td>
    </tr>
