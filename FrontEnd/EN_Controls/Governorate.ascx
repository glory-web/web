...
<asp:MultiView ID="MultiView1" runat="server">
    <asp:View ID="View1" runat="server">
        <asp:GridView ID="governorate_grid" runat="server" AutoGenerateColumns="False" ShowHeader="False">
            <Columns>
                <asp:TemplateField HeaderText="Govrernerates">
                    <ItemTemplate>
                        <asp:LinkButton CssClass="HighLightsItems" ID="LinkButton1" runat="server" OnClick="LinkButton1_Click"
                            Text='<%# Bind("ORG_English_Name") %>'>LinkButton</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
        ...
        <table class="front" width="100%">
            <tr>
                <td class="bg" style="width: 177px">
                    <asp:Label ID="Label1" runat="server" CssClass="Label_form" Text="Directorate Name"></asp:Label></td>
                <td class="bg2">
                    <asp:Label ID="Lit_name" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td class="bg" style="width: 177px">
                    <asp:Label ID="Label6" runat="server" CssClass="Label_form" Text="Directorate Manger"></asp:Label></td>
                <td class="bg2">
            ...
            <tr>
                <td class="bg" style="width: 177px">
                    <asp:Label ID="Literal1" runat="server" CssClass="Label_form" Text="Telephones"></asp:Label></td>
                <td class="bg2">
                    <asp:Label ID="Lit_Telephone" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td class="bg" style="width: 177px">
                    <asp:Label ID="Literal2" runat="server" CssClass="Label_form" Text="Fax "></asp:Label></td>
                <td class="bg2">
                    <asp:Label ID="Lit_Fax" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td class="bg" style="width: 177px">
                    <asp:Label ID="Label3" runat="server" CssClass="Label_form" Text="Mail  " Width="128px"></asp:Label></td>
                <td class="bg2">
                    <asp:Label ID="Label_Mail" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td class="bg" style="width: 177px">
                    <asp:Label ID="Label5" runat="server" CssClass="Label_form" Text="Address"></asp:Label></td>
                <td class="bg2">
                    <asp:Label ID="Lit_Addreess" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td class="bg" style="width: 177px">
                    <asp:Label ID="Label7" runat="server" CssClass="Label_form" Text="Directorate History "></asp:Label></td>
                <td class="bg2">
                    <asp:Label ID="Lit_History" runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td class="bg" style="width: 177px">
                    <asp:Label ID="Label2" runat="server" CssClass="Label_form" Text="Departments Related "></asp:Label></td>
                <td class="bg2">
                 <asp:GridView ID="gov_dep_grid" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                Width="60%">
                                <Columns>
                                    <asp:TemplateField HeaderText="Depertements">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="Link_Sluter" runat="server" OnClick="Link_Sluter_Click">Sluters</asp:LinkButton>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="Link_Unit" runat="server" OnClick="Link_Unit_Click">Units</asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                          ...
                          <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Underline="True"></asp:Label>
                            <asp:GridView ID="Grid_unit_sluter" runat="server" AutoGenerateColumns="False" ShowHeader="False"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Govrernerates">
                                        <ItemTemplate>
                                            <asp:Label ID="Lable_org_name" runat="server" Text='<%# Bind("ORG_English_Name") %>'>LinkButton</asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
                            <asp:LinkButton ID="Link_Close" runat="server" OnClick="Link_Close_Click">Close</asp:LinkButton>
                            </td></tr></table>
                            </asp:View>
                    </asp:MultiView></td>
            </tr>
