...
<asp:MultiView ID="MultiView1" runat="server">
    <asp:View ID="View1" runat="server">
        <asp:GridView ID="projects_grid" runat="server" AutoGenerateColumns="False" ShowHeader="true">
            <Columns>
                <asp:TemplateField HeaderText="Current Project">
    ...
    <asp:View ID="View2" runat="server">
        <table class="front">
           ...
           <tr>
            ...
            <tr>
                <td class="bg">
                    <asp:Label CssClass="Label_form" ID="Label3" runat="server" Text="Start Date" ></asp:Label></td>
                 <td class="bg2">
                    <asp:Label CssClass="Label_details" ID="Label_Project_StartDate" runat="server" ></asp:Label></td>
            </tr>
            <tr>
                <td class="bg">
                    <asp:Label CssClass="Label_form" ID="Label4" runat="server" Text="End Date  " ></asp:Label></td>
                 <td class="bg2">
           ...
           <%-- <tr>
                <td class="bg">
                    <asp:Label CssClass="Label_form" ID="Label6" runat="server" Text="ãáÝÇÊ ÇáãÔÑæÚ" ></asp:Label></td>
                 <td class="bg2">
        ...
        <asp:Label ID="NoProject" runat="server" Text="No Current Projects " Visible="False"
