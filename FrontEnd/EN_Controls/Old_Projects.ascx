    ...
    <asp:View ID="View2" runat="server">
      <table class="front">
          ...
          <tr>
            ...
            <%--<tr>
                <td class="bg">
                    <asp:Label CssClass="Label_form" ID="Label6" runat="server" Text="ãáÝÇÊ ÇáãÔÑæÚ"></asp:Label>
               </td><td class="bg2">
        ...
        <asp:Label ID="NoProject" runat="server" Text="áÇ íæÌÏ ãÔÇÑíÚ " Visible="False"
