<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Law.ascx.cs" Inherits="UserControls_Law" %>
                            ...
                            <asp:MultiView ID="MultiView1" runat="server">
                                <asp:View ID="View1" runat="server">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" ShowFooter="True"
                                        Width="100%">
                                        <Columns>
                                            <asp:TemplateField HeaderText="اسم القانون">
                                                <ItemTemplate>
                                    ...
                                    <table width="100%">
                                                    <tr>
                                                        <td style="width: 175px">
                                                            <asp:Literal ID="LITCoopAraic" runat="server" Text="اسم القانون باللغة العربية"></asp:Literal></td>
                                                        <td colspan="2">
                                                    ...
                                                    <tr>
                                                        <td style="width: 175px">
                                                            <asp:Literal ID="Literal3" runat="server" Text="اسم القانون باللغة الإنجليزية"></asp:Literal></td>
                                                        <td colspan="2">
                                                    ...
                                                    <tr>
                                                        <td style="height: 15px; width: 175px;">
                                                            <asp:Literal ID="Literal4" runat="server" Text="ملخص القانون باللغة العربية"></asp:Literal></td>
                                                    ...
                                                    <tr>
                                                        <td style="width: 175px">
                                                            <asp:Literal ID="Literal2" runat="server" Text="ملخص القانون باللغة الإنجليزية"></asp:Literal></td>
                                                        <td colspan="2">
                                                    ...
                                                    <tr>
                                                        <td style="width: 175px; height: 26px;">
                                                            <asp:Literal ID="Literal5" runat="server" Text="سنة إصدار القانون"></asp:Literal></td>
                                     ...
                                     <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                                                    <ItemTemplate>
                                                        <table width="100%">
                                                            <tr>
                                                                <td>
                                                                    <asp:Literal ID="Literal7" runat="server" Text="اسم القانون باللغة العربية"></asp:Literal>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Literal ID="Literal9" runat="server" Text="اسم القانون باللغة الإنجليزية"></asp:Literal>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Literal ID="Literal11" runat="server" Text="تفاصيل القانون باللغة العربية"></asp:Literal>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Literal ID="Literal13" runat="server" Text="تفاصيل القانون باللغة الإنجليزية"></asp:Literal>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Literal ID="Literal15" runat="server" Text="سنة إصدار القانون"></asp:Literal>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Literal ID="Literal18" runat="server" Text="نوع القانون تم إلغاءة أو معمل به"></asp:Literal>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <asp:Literal ID="Literal17" runat="server" Text="ملف القانون"></asp:Literal>
                                                                </td>
                                                                <td>
